...
from sklearn.metrics import accuracy_score  # 添加这行导入
...
if __name__ == '__main__':
    ...
    # 修复段错误问题：移除 k-bit 训练相关代码
    # 因为 Deberta 模型默认不是 8-bit 量化模型
    ...
    def compute_metrics(eval_pred):
        ...
        acc = accuracy_score(labels, predictions)  # 现在这个函数已经导入了
        return {"accuracy": acc}
    ...
    result_output.to_csv("./result/deberta_prompt_int8.csv", index=False, quoting=3)
